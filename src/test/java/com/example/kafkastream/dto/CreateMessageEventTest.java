...
class CreateMessageEventTest {
    ...
    void testCreateMessageEventCreation() {
        ...
        assertEquals("123456789011", event.getSenderPhone());
    ...
    void testCreateMessageEventJsonSerialization() throws Exception {
        CreateMessageEvent event = new CreateMessageEvent(
                "msg-123", "123456789011", "123456789011", "text", "Hello World", 1747854609182L);
        
        // Test serialization
        String json = objectMapper.writeValueAsString(event);
        assertNotNull(json);
        assertTrue(json.contains("\"message_id\":\"msg-123\""));
        assertTrue(json.contains("\"sender_phone\":\"123456789011\""));
    ...
    void testCreateMessageEventToString() {
        CreateMessageEvent event = new CreateMessageEvent(
                "msg-123", "123456789011", "123456789011", "text", "Test message", 1747854609182L);
