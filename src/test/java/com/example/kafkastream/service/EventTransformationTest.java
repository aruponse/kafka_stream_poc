...
class EventTransformationTest {
    ...
    void testInboundMessageEventToCreateChatEventTransformation() {
        ...
        assertEquals("593987699757", chatEvent.getChatId());
        assertEquals("Aruponse", chatEvent.getUserName());
        assertEquals("593987699757", chatEvent.getUserPhone());
        assertEquals("593", chatEvent.getCountryCode());
        assertEquals("987699757", chatEvent.getDialCode());
    ...
    void testInboundMessageEventToCreateMessageEventTransformation() {
        ...
        assertEquals("593987699757", messageEvent.getSenderPhone());
        assertEquals("593987699757", messageEvent.getChatId());
